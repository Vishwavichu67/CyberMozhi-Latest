 ...
 * NO 'use server' directive — imported by both cyber-law-chatbot.ts and route.ts.
 */

import type { CyberLawChatbotInput } from './types';

export function buildCyberMozhiSystemPrompt(): string {
...
STRICT RESPONSE FORMAT — always use this exact structure:
...
[If from your database, cite it. If general knowledge, say "Based on general knowledge:"]
